...
export const PROGRAMS: Program[] = [
  {
    ...
    description: 'Immersive classroom experience at our learning environments with native Saudi linguists.',
    descriptionAr: 'تجربة تعليمية حضورية ملهمة في بيئة تعليمية ملهمة مع نخبة من الأساتذة السعوديين.',
    iconName: 'landmark',
    duration: '8 - 12 Weeks',
    durationAr: '8 - 12 أسبوعاً',
    format: 'In-Person Classroom',
    formatAr: 'قاعات دراسية وتفاعل حي',
